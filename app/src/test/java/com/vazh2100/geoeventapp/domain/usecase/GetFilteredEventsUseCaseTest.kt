...
class GetFilteredEventsUseCaseTest {
    ...
    private val preferencesStorage: PreferencesStorage = mockk()
    private val getNetworkStatusUseCase: GetNetworkStatusUseCase = mockk()
    private val getLocationStatusUseCase: GetLocationStatusUseCase = mockk()
    ...
    fun setUp() {
        ...
        mockkStatic("com.vazh2100.geoeventapp.domain.entities.event.EventsProcessorKt")
